...
public class OldTokenizer {
    ...
    public OldTokenizer parseTokens(String code) throws IOException {
...
//                    result.add(new Token("" + ((char) tt), TokenType.IDENTIFIER));
    ...
    public OldTokenizer parseTokens1(String code) {
...
//            }
    ...
    public OldTokenizer parseTokens2(String codeString) {
    ...
    public static void main(String[] args) throws IOException {
        OldTokenizer tokenizer = new OldTokenizer();
